...
| Нотация | Определение и аналогия |
|:-------:|:----------------------|
| <br> **$O(f(n))$** | $g(n) \leq c \cdot f(n)$ <br> *Аналогично:* $\leq$ |
| **$\Omega(f(n))$** | $g(n) \geq c \cdot f(n)$ <br> *Аналогично:* $\geq$ |
| **$\Theta(f(n))$** | $c_1 \cdot f(n) \leq g(n) \leq c_2 \cdot f(n)$ <br> *Аналогично:* $=$ |
| **$o(f(n))$** | $\lim\limits_{n \to \infty} \frac{g(n)}{f(n)} = 0$ <br> *Аналогично:* $<$ |
| **$\omega(f(n))$** | $\lim\limits_{n \to \infty} \frac{g(n)}{f(n)} = \infty$ <br> *Аналогично:* $>$ |
